...
// PeerInfo represents a short summary of the Amazoncoin sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Amazoncoin protocol version negotiated
