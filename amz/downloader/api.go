...
// Syncing provides information when this nodes starts synchronising with the Amazoncoin network and when it's finished.
...
type SyncingResult struct {
	...
	Status  amazoncoin.SyncProgress `json:"status"`
}
