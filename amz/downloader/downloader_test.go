...
type downloadTester struct {
	...
	stateDb amzdb.Database // Database used by the tester for syncing from peers
	peerDb  amzdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = amzdb.NewMemDatabase()
