...
// PublicAmazonCoinAPI provides an API to access Amazoncoin full node-related
// information.
type PublicAmazonCoinAPI struct {
	e *AmazonCoin
}

// NewPublicAmazonCoinAPI creates a new Etheruem protocol API for full nodes.
func NewPublicAmazonCoinAPI(e *AmazonCoin) *PublicAmazonCoinAPI {
	return &PublicAmazonCoinAPI{e}
}

// Amazoncoinbase is the address that mining rewards will be send to
func (api *PublicAmazonCoinAPI) Amazoncoinbase() (common.Address, error) {
	return api.e.Amazoncoinbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Amazoncoinbase)
func (api *PublicAmazonCoinAPI) Coinbase() (common.Address, error) {
	return api.Amazoncoinbase()
}

// Hashrate returns the POW hashrate
func (api *PublicAmazonCoinAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *AmazonCoin) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *AmazonCoin) *PrivateMinerAPI {
...
// SetAmazoncoinbase sets the amazoncoinbase of the miner
func (api *PrivateMinerAPI) SetAmazoncoinbase(amazoncoinbase common.Address) bool {
	api.e.SetAmazoncoinbase(amazoncoinbase)
	return true
}
...
// admin methods of the Amazoncoin service.
func NewPrivateAdminAPI(eth *AmazonCoin) *PrivateAdminAPI {
...
// related public debug methods of the Amazoncoin service.
func NewPublicDebugAPI(eth *AmazonCoin) *PublicDebugAPI {
...
// private debug methods of the Amazoncoin service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *AmazonCoin) *PrivateDebugAPI {
