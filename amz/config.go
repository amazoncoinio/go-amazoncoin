...
// DefaultConfig contains default settings for use on the Amazoncoin main net.
...
type Config struct {
	...
	// If nil, the Amazoncoin main net block is used.
	...
	Amazoncoinbase    common.Address `toml:",omitempty"`
