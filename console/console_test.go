...
import (
	...
	"github.com/amazoncoinio/go-amazoncoin/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Amazoncoin service within
	...
	ethConf := &eth.Config{
		...
		Amazoncoinbase: common.HexToAddress(testAddress),
		PowTest:   true,
	}
	if confOverride != nil {
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return eth.New(ctx, ethConf) }); err != nil {
		t.Fatalf("failed to register Amazoncoin protocol: %v", err)
	}
	...
	stack.Service(&amazoncoin)

	return &tester{
		workspace: workspace,
		stack:     stack,
		amazoncoin:  amazoncoin,
		console:   console,
		input:     prompter,
		output:    printer,
	}
