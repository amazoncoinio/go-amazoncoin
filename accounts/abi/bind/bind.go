...
// Package bind generates Amazoncoin contract Go bindings.
//
// Detailed usage document and tutorial available on the go-amazoncoin Wiki page:
// https://github.com/amazoncoinio/go-amazoncoin/wiki/Native-DApps:-Go-bindings-to-AmazonCoin-contracts
package bind
