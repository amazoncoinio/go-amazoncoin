...
type SimulatedBackend struct {
	database   amzdb.Database   // In memory database to store our testing data
	blockchain *core.BlockChain // Amazoncoin blockchain to handle the consensus
...
func NewSimulatedBackend(alloc core.GenesisAlloc) *SimulatedBackend {
	database, _ := amzdb.NewMemDatabase()
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call amazoncoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call amazoncoin.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call amazoncoin.CallMsg) (*big.Int, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call amazoncoin.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, *big.Int, error) {
