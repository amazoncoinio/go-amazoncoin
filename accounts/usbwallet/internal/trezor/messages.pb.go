...
const (
	...
	MessageType_MessageType_AmazonCoinGetAddress       MessageType = 56
	MessageType_MessageType_AmazonCoinAddress          MessageType = 57
	MessageType_MessageType_AmazonCoinSignTx           MessageType = 58
	MessageType_MessageType_AmazonCoinTxRequest        MessageType = 59
	MessageType_MessageType_AmazonCoinTxAck            MessageType = 60
	...
	MessageType_MessageType_AmazonCoinSignMessage      MessageType = 64
	MessageType_MessageType_AmazonCoinVerifyMessage    MessageType = 65
	MessageType_MessageType_AmazonCoinMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_AmazonCoinGetAddress",
	57:  "MessageType_AmazonCoinAddress",
	58:  "MessageType_AmazonCoinSignTx",
	59:  "MessageType_AmazonCoinTxRequest",
	60:  "MessageType_AmazonCoinTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_AmazonCoinSignMessage",
	65:  "MessageType_AmazonCoinVerifyMessage",
	66:  "MessageType_AmazonCoinMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_AmazonCoinGetAddress":       56,
	"MessageType_AmazonCoinAddress":          57,
	"MessageType_AmazonCoinSignTx":           58,
	"MessageType_AmazonCoinTxRequest":        59,
	"MessageType_AmazonCoinTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_AmazonCoinSignMessage":      64,
	"MessageType_AmazonCoinVerifyMessage":    65,
	"MessageType_AmazonCoinMessageSignature": 66,
...
// *
// Request: Ask device for Amazoncoin address corresponding to address_n path
// @next PassphraseRequest
// @next AmazonCoinAddress
// @next Failure
type AmazonCoinGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *AmazonCoinGetAddress) Reset()                    { *m = AmazonCoinGetAddress{} }
func (m *AmazonCoinGetAddress) String() string            { return proto.CompactTextString(m) }
func (*AmazonCoinGetAddress) ProtoMessage()               {}
func (*AmazonCoinGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *AmazonCoinGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *AmazonCoinGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Amazoncoin address derived from device private seed
// @prev AmazonCoinGetAddress
type AmazonCoinAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *AmazonCoinAddress) Reset()                    { *m = AmazonCoinAddress{} }
func (m *AmazonCoinAddress) String() string            { return proto.CompactTextString(m) }
func (*AmazonCoinAddress) ProtoMessage()               {}
func (*AmazonCoinAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *AmazonCoinAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next AmazonCoinTxRequest
// @next Failure
type AmazonCoinSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *AmazonCoinSignTx) Reset()                    { *m = AmazonCoinSignTx{} }
func (m *AmazonCoinSignTx) String() string            { return proto.CompactTextString(m) }
func (*AmazonCoinSignTx) ProtoMessage()               {}
func (*AmazonCoinSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *AmazonCoinSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *AmazonCoinSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *AmazonCoinSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *AmazonCoinSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *AmazonCoinSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *AmazonCoinSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *AmazonCoinSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *AmazonCoinSignTx) GetDataLength() uint32 {
...
func (m *AmazonCoinSignTx) GetChainId() uint32 {
...
// @prev AmazonCoinSignTx
// @next AmazonCoinTxAck
type AmazonCoinTxRequest struct {
...
func (m *AmazonCoinTxRequest) Reset()                    { *m = AmazonCoinTxRequest{} }
func (m *AmazonCoinTxRequest) String() string            { return proto.CompactTextString(m) }
func (*AmazonCoinTxRequest) ProtoMessage()               {}
func (*AmazonCoinTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *AmazonCoinTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *AmazonCoinTxRequest) GetSignatureV() uint32 {
...
func (m *AmazonCoinTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *AmazonCoinTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev AmazonCoinTxRequest
// @next AmazonCoinTxRequest
type AmazonCoinTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *AmazonCoinTxAck) Reset()                    { *m = AmazonCoinTxAck{} }
func (m *AmazonCoinTxAck) String() string            { return proto.CompactTextString(m) }
func (*AmazonCoinTxAck) ProtoMessage()               {}
func (*AmazonCoinTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *AmazonCoinTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next AmazonCoinMessageSignature
// @next Failure
type AmazonCoinSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *AmazonCoinSignMessage) Reset()                    { *m = AmazonCoinSignMessage{} }
func (m *AmazonCoinSignMessage) String() string            { return proto.CompactTextString(m) }
func (*AmazonCoinSignMessage) ProtoMessage()               {}
func (*AmazonCoinSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *AmazonCoinSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *AmazonCoinSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type AmazonCoinVerifyMessage struct {
...
func (m *AmazonCoinVerifyMessage) Reset()                    { *m = AmazonCoinVerifyMessage{} }
func (m *AmazonCoinVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*AmazonCoinVerifyMessage) ProtoMessage()               {}
func (*AmazonCoinVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *AmazonCoinVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *AmazonCoinVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *AmazonCoinVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev AmazonCoinSignMessage
type AmazonCoinMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *AmazonCoinMessageSignature) Reset()                    { *m = AmazonCoinMessageSignature{} }
func (m *AmazonCoinMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*AmazonCoinMessageSignature) ProtoMessage()               {}
func (*AmazonCoinMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *AmazonCoinMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *AmazonCoinMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*AmazonCoinGetAddress)(nil), "AmazonCoinGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*AmazonCoinAddress)(nil), "AmazonCoinAddress")
	...
	proto.RegisterType((*AmazonCoinSignTx)(nil), "AmazonCoinSignTx")
	proto.RegisterType((*AmazonCoinTxRequest)(nil), "AmazonCoinTxRequest")
	proto.RegisterType((*AmazonCoinTxAck)(nil), "AmazonCoinTxAck")
	proto.RegisterType((*AmazonCoinSignMessage)(nil), "AmazonCoinSignMessage")
	proto.RegisterType((*AmazonCoinVerifyMessage)(nil), "AmazonCoinVerifyMessage")
	proto.RegisterType((*AmazonCoinMessageSignature)(nil), "AmazonCoinMessageSignature")
