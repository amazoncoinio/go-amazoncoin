...
// See https://github.com/amazoncoinio/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Amazoncoin presale wallet and stores
