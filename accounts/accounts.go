...
// Package accounts implements high level Amazoncoin account management.
package accounts
...
// Account represents an Amazoncoin account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Amazoncoin account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain amazoncoin.ChainStateReader)
