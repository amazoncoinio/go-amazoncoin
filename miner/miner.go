...
// Package miner implements Amazoncoin block creation and mining.
package miner
...
func (self *Miner) Start(coinbase common.Address) {
	atomic.StoreInt32(&self.shouldStart, 1)
	self.worker.setAmazoncoinbase(coinbase)
...
func (self *Miner) SetAmazoncoinbase(addr common.Address) {
	self.coinbase = addr
	self.worker.setAmazoncoinbase(addr)
}
