...
// that address/topic, and binary AND-ing those vectors togetaer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togetaer
				var orVector []byte
...
// the reuested retrieval queue to be serviced togetaer with other sessions.
//
