...
func makeTestState() (Database, *amzdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := amzdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db amzdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db amzdb.Database, root common.Hash) error {
...
func checkStateConsistency(db amzdb.Database, root common.Hash) error {
