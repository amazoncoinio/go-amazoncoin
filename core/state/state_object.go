...
// stateObject represents an Amazoncoin account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of Amazoncoin address of the account
	data     Account
	db       *StateDB
...
// Account is the Amazoncoin consensus representation of accounts.
