...
// Package core implements the Amazoncoin consensus protocol.
package core
...
import (
	...
	"github.com/amazoncoinio/go-amazoncoin/common/mclock"
...
// available in the database. It initialises the default Amazoncoin Validator and
// Processor.
func NewBlockChain(chainDb amzdb.Database, config *params.ChainConfig, engine consensus.Engine, vmConfig vm.Config) (*BlockChain, error) {
...
func (bc *BlockChain) InsertReceiptChain(blockChain types.Blocks, receiptChain []types.Receipts) (int, error) {
	...
	for i, block := range blockChain {
		...
		if batch.ValueSize() >= amzdb.IdealBatchSize {
