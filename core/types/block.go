...
// Package types contains data types related to Amazoncoin consensus.
package types
...
// Header represents a block header in the Amazoncoin blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) togetaer.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Amazoncoin blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the AmazonCoin
...
// EncodeRLP serializes b into the Amazoncoin RLP block format.
