...
func SetupGenesisBlock(db amzdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) Commit(db amzdb.Database) (*types.Block, error) {
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db amzdb.Database) *types.Block {
...
func GenesisBlockForTesting(db amzdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Amazoncoin main net genesis block.
...
// DevGenesisBlock returns the 'geta --dev' genesis block.
