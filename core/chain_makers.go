...
func GenerateChain(config *params.ChainConfig, parent *types.Block, db amzdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
// header only chain.
func newCanonical(n int, full bool) (amzdb.Database, *BlockChain, error) {
...
func makeHeaderChain(parent *types.Header, n int, db amzdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, db amzdb.Database, seed int) []*types.Block {
