...
// Package ethclient provides a client for the Amazoncoin RPC API.
package ethclient
...
import (
	...
	"github.com/amazoncoinio/go-amazoncoin"
...
// Client defines typed wrappers for the Amazoncoin RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) getBlock(ctx context.Context, method string, args ...interface{}) (*types.Block, error) {
	...
	if err != nil {
		...
		return nil, amazoncoin.NotFound
	}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, amazoncoin.NotFound
	}
...
func (ec *Client) SyncProgress(ctx context.Context) (*amazoncoin.SyncProgress, error) {
	var raw json.RawMessage
	...
	return &amazoncoin.SyncProgress{
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (amazoncoin.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q amazoncoin.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q amazoncoin.FilterQuery, ch chan<- types.Log) (amazoncoin.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q amazoncoin.FilterQuery) interface{} {
...
func (ec *Client) CallContract(ctx context.Context, msg amazoncoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg amazoncoin.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg amazoncoin.CallMsg) (*big.Int, error) {
	var hex hexutil.Big
...
func toCallArg(msg amazoncoin.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
