...
// Service implements an Amazoncoin netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.AmazonCoin      // Full Amazoncoin service if monitoring a full node
	les    *les.LightAmazonCoin // Light Amazoncoin service if monitoring a light node
...
func New(url string, ethServ *eth.AmazonCoin, lesServ *les.LightAmazonCoin) (*Service, error) {
