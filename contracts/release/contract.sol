...
// ReleaseOracle is an Amazoncoin contract to store the current and previous
// versions of the go-amazoncoin implementation. Its goal is to allow Geth to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an Amazoncoin user, either
