...
// Package chequebook package wraps the 'chequebook' Amazoncoin smart contract.
//
...
import (
	...
	"github.com/amazoncoinio/go-amazoncoin/contracts/chequebook/contract"
	...
	"github.com/amazoncoinio/go-amazoncoin/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an Amazoncoin transaction.
