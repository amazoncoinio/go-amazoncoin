...
// Contains a wrapper for the Amazoncoin client.
...
import (
	...
	"github.com/amazoncoinio/go-amazoncoin/amzclient"
)

// AmazonCoinClient provides access to the Amazoncoin APIs.
type AmazonCoinClient struct {
	client *ethclient.Client
}

// NewAmazonCoinClient connects a client to the given URL.
func NewAmazonCoinClient(rawurl string) (client *AmazonCoinClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &AmazonCoinClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *AmazonCoinClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *AmazonCoinClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *AmazonCoinClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *AmazonCoinClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *AmazonCoinClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *AmazonCoinClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *AmazonCoinClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *AmazonCoinClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *AmazonCoinClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *AmazonCoinClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *AmazonCoinClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *AmazonCoinClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *AmazonCoinClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *AmazonCoinClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *AmazonCoinClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *AmazonCoinClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *AmazonCoinClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *AmazonCoinClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *AmazonCoinClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *AmazonCoinClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *AmazonCoinClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *AmazonCoinClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *AmazonCoinClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *AmazonCoinClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *AmazonCoinClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *AmazonCoinClient) SendTransaction(ctx *Context, tx *Transaction) error {
