...
// Contains all the wrappers from the go-amazoncoin root package.
...
// the Amazoncoin network.
type SyncProgress struct {
	progress amazoncoin.SyncProgress
}
