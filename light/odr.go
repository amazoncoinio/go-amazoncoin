...
// for the Amazoncoin Light Client.
package light
...
type OdrBackend interface {
	Database() amzdb.Database
	Retrieve(ctx context.Context, req OdrRequest) error
}

// OdrRequest is an interface for retrieval requests
type OdrRequest interface {
	StoreResult(db amzdb.Database)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db amzdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db amzdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db amzdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db amzdb.Database) {
