...
type wizard struct {
	...
	services map[string][]string   // Amazoncoin services known to be running on servers
...
// converts it to an Amazoncoin address. If an empty line is entered, the default
// value is returned.
