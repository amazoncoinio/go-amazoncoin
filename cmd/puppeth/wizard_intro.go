...
// setting up a new or managing an existing Amazoncoin private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Amazoncoin private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Amazoncoin network down to  |")
	...
	log.Info("Administering Amazoncoin network", "name", w.network)
