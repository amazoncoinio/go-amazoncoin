...
import (
	...
	"github.com/amazoncoinio/go-amazoncoin/cmd/utils"
	"github.com/amazoncoinio/go-amazoncoin/common"
	"github.com/amazoncoinio/go-amazoncoin/console"
	"github.com/amazoncoinio/go-amazoncoin/contracts/ens"
	"github.com/amazoncoinio/go-amazoncoin/crypto"
	"github.com/amazoncoinio/go-amazoncoin/amzclient"
	"github.com/amazoncoinio/go-amazoncoin/internal/debug"
	...
	"github.com/amazoncoinio/go-amazoncoin/swarm"
	bzzapi "github.com/amazoncoinio/go-amazoncoin/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the Amazoncoin API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the Amazoncoin API provider to use for ENS record lookups",
		Value: node.DefaultIPCEndpoint("geta"),
	}
...
// This init function sets defaults so cmd/swarm can run alongside geta.
func init() {
...
var app = utils.NewApp(gitCommit, "AmazonCoin Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-amazoncoin Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.amazoncoin/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.amazoncoin/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.amazoncoin/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.amazoncoin/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
