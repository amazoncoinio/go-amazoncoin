...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "geta.ipc", false, filepath.Join(os.TempDir(), "geta.ipc")},
		{"data", "geta.ipc", false, "data/geta.ipc"},
		{"data", "./geta.ipc", false, "./geta.ipc"},
		{"data", "/geta.ipc", false, "/geta.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "geta.ipc", true, `\\.\pipe\geta.ipc`},
		{"data", "geta.ipc", true, `\\.\pipe\geta.ipc`},
		{"data", `\\.\pipe\geta.ipc`, true, `\\.\pipe\geta.ipc`},
	}
