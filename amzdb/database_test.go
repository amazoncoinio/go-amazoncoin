...
func newTestLDB() (*amzdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "amzdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := amzdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db amzdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db amzdb.Database, t *testing.T) {
	const n = 8
