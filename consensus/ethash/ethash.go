...
// all blocks' seal as valid, though they still have to conform to the AmazonCoin
// consensus rules.
...
// still have to conform to the Amazoncoin consensus rules.
...
// they still have to conform to the Amazoncoin consensus rules.
