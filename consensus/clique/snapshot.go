...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db amzdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db amzdb.Database) error {
