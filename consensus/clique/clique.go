...
import (
	...
	"github.com/amazoncoinio/go-amazoncoin/crypto/sha3"
...
// ecrecover extracts the Amazoncoin account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Amazoncoin address
...
// Amazoncoin testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     amzdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Amazoncoin address of the signing key
...
func New(config *params.CliqueConfig, db amzdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Amazoncoin address recovered
