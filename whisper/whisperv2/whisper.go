...
import (
	...
	"github.com/amazoncoinio/go-amazoncoin/crypto/ecies"
	"github.com/amazoncoinio/go-amazoncoin/event/filter"
...
// Whisper represents a dark communication interface through the AmazonCoin
...
// New creates a Whisper client ready to communicate through the Amazoncoin P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
