...
// See https://github.com/amazoncoinio/EIPs/issues/176 for the test format specification.
...
func makePreState(db amzdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/amazoncoinio/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
